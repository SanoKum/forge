...
> スキームの理論的背景や実装の詳細は `docs/<area>/` を参照すること (例: 対流スキームは [`../docs/convection/`](../docs/convection/)、
> 時間積分は [`../docs/time_integration/`](../docs/time_integration/))。ここは「どの値を選ぶか」、`docs/` は「なぜそう動くか」を担う。

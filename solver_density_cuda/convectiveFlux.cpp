...
//
//    ro_a = sqrt(roL*roR);
//    Ux_a= (sqrt(roL)*uL + sqrt(roR)*uR)/(sqrt(roL)+sqrt(roR));
//    Uy_a= (sqrt(roL)*vL + sqrt(roR)*vR)/(sqrt(roL)+sqrt(roR));
//    Uz_a= (sqrt(roL)*wL + sqrt(roR)*wR)/(sqrt(roL)+sqrt(roR));
//    H_a= (sqrt(roL)*HL + sqrt(roR)*HR)/(sqrt(roL)+sqrt(roR));

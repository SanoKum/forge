...
public:
    ...
    int chemTci = 0;                           // 1: PaSR (κ=τ_c/(τ_c+τ_mix) で ω・Q̇・Jacobian をスケール)。RANS SST 時のみ有効
    ...
    double chemCmcTauRelax = 1.0e-4; // couple 7: 平均場を PDF 積分状態へ緩和する物理時間 [s] (ω_s=ρ(Ỹ_pdf−Y)/τ_c, Q̇=ρ g (h_pdf−h)/τ_c)

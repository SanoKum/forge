...
- **related_docs**:
  ...
  - `docs/turbulence/implementation.md` (§5.3.1)
- **related_plans**: なし
- **created**: `2026-06-12`
- **owner**: `CFD Dev`
...
- 理論: [`docs/turbulence/theory.md`](../../docs/turbulence/theory.md) §7.5。
- 実装: [`docs/turbulence/implementation.md`](../../docs/turbulence/implementation.md) §5.3.1。
...
- docs: `docs/turbulence/{theory,implementation}.md` 更新済み、`docs/index.md` は既存項目内。

## 8. 完了条件

- [x] `docs/turbulence/theory.md` 更新済み (§7.5)
- [x] `docs/turbulence/implementation.md` 更新済み (§5.3.1)
- [x] 実装・検証完了 (§6)

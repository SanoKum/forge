...
For iconv In {1 : nx_conv}
	...
	Point(pListC2[iconv]) = {x , 0 , 0.0 , lc};
EndFor
...
Point(pListS2[1]) = {-L_strght,0.0,0.0, lc};
lst2 = newl;
...
//temp Extrude {{1, 0, 0}, {0, 0, 0}, Pi/30} {
Extrude {0, 0, 5} {
  Surface{1,2,3}; Layers{1}; Recombine;
}
...
Physical Surface("bottom", 4) = {27, 49, 71};
Physical Surface("slip", 5) = {1, 32, 2, 54, 3, 76};

...
| `run_0074_moo_top_r1` | **③ベル TOP dv の本番 MOO キャンペーン** (DOE24 + EHVI infill 2×13 = 50 評価, seed=run_0072, ref=(−0.90,13), 評価は eval タグ別サブディレクトリ) | (実行中 2026-08-13) `ledger.jsonl` に全評価の VERDICT/物理ゲート記録、完了時 `pareto.json` | active (**Phase 2 本番**) |

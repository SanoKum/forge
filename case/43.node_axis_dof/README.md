...
| `run_0050_ns_van_em_kappa` / `run_0051_ns_van_em_kappa_cont` | 0047 末尾から `convMethod: 2` (κ=1/3 MUSCL) 6000 / +16000 step | 0050: 市松 2536 → **100 Pa**、rms_ro 4.1e-9・roUy 5.1e-6 (10 倍改善)。0051 継続 | active (**NS 推奨設定の根拠**) |

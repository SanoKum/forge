...
def write_geo_file_with_outer_box_and_mesh(x, y, filename="naca2412_with_box.geo"):
    ...
    lines += [
        ...
        "Physical Surface(\"wall\", 5) = {41,45};\n",
        "Physical Surface(\"side1\", 6) = {62};\n",
        "Physical Surface(\"side2\", 7) = {1};\n",
...
if __name__ == '__main__':
    ...
    # Generate the NACA 4-digit airfoil coordinates
    ...
    write_geo_file_with_outer_box_and_mesh(x, y, "naca.geo")

...
| `run_node_sst_5e` | **node 弱形式境界 (5a+5b+5e)** SST (10000 step, run_node_sst_fine から restart) | プラトー打破: rms_roUx 0.597→2.14e-3 (2.4桁 falling, 旧 0.23 STALLED)。mean flow 全列 falling。roK は微増 (壁せん断=5c 課題) | active |

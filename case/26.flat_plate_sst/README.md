...
| **E3 (`run_0071`)** | **1374.3 Pa** | 1421.1 K | **1.1226** | **1.1414** (旧推定 ≈1.061 は撤回) |
...
| 壁法則 | 実測/則 ($x$=0.451) | ($x$=0.800) |
| --- | --- | --- |
| Reichardt | 0.9490 | 0.9477 |
| **Spalding** | **1.0218** | **1.0198** |
| 純対数則 ($\kappa$=0.41, $B$=5.0) | 0.9718 | 0.9672 |

**全法則共通ではない** — Spalding では逆に 2% 超過する。法則間の広がり (0.948–1.022 = 7%) は
問題の 5% と同程度であり、**差の相当部分は「どの内挿式を壁法則と呼ぶか」に由来する**。

...
ap.add_argument("--eps", type=float, default=0.15); ap.add_argument("--precond", type=int, default=2); ap.add_argument("--axisdir", type=int, default=0); ap.add_argument("--nojet", type=int, default=0); ap.add_argument("--single", type=int, default=0); ap.add_argument("--coupling", type=int, default=2); ap.add_argument("--iccol", type=int, default=1); ap.add_argument("--planar", type=int, default=0); ap.add_argument("--jetn2", type=int, default=0); ap.add_argument("--jetcof", type=int, default=0); ap.add_argument("--far", default="slip"); ap.add_argument("--mixfrac", type=int, default=0); ap.add_argument("--cchi", type=float, default=2.0); ap.add_argument("--mesh", default="mesh/cabra.msh"); ap.add_argument("--sfr", type=int, default=0); a = ap.parse_args()
...
chem = "" if a.single else f"chemistry: {{enabled: {a.chem}, mechanismFile: \"mech.yaml\", jacobianMode: {a.jac}, jacobianInterval: {a.ji}, tci: {a.tci}, tciCmix: {a.cmix}, tciTauChem: 1{mixfrac}}}"
if a.single: chem = ""

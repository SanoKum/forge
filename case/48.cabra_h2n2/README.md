...
| `run_0110_cmc_tc1030` … `run_0113_cmc_tc1075` | **T_c 応答曲線** (`run_tc_sweep.sh`): run_0107 の状態から coflow T_c = 1030/1060/1015/1075 K で各 5000 step (50 ms) dual-time | (順次実行中, ログ `tc_sweep_2026-09-06.log`) | active |

...
| `run_0108_dt_c7_cont` | run_0107 の続き (修正後バイナリ) 4000 step = 40 ms: T_c=1045 K の基準場、火炎基部の定常確認 | (実行中) | active |
| `run_0110_cmc_tc1030` | **T_c 応答曲線** (`run_tc_sweep.sh`): run_0107 の状態から coflow T_c = 1030 K, 5000 step (50 ms) dual-time | (実行中, ログ `tc_sweep_2026-09-06.log`; 1060/1015/1075 K は 3000 step で後続 → run_0111–0113 予定) | active |

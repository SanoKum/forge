...
| `run_0083_cmc_react_couple3` | **couple 3 (平均 Y,T を PDF 積分状態へ α=0.05/step でブレンド、平均方程式の化学ソース 0)**, 分散復元修正後 (res_0 xiVar 0.041), 他は run_0082 と同一 (6000 step) | 全置換版は step 14 で NaN (dt 1.5e-9) → α ブレンド版は NaN なく進行中 (852 ms/step, GPU 共有) | active |

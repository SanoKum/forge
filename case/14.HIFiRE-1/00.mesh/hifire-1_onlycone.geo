...
cone_lines[2] = newl;
Line(cone_lines[2]) = {pList1[3], pList1[4]}; Transfinite Line {cone_lines[2]} = nx_2 Using Progression 1.00;
cone_lines[3] = newl;
Line(cone_lines[3]) = {pList1[4], pList1[5]}; Transfinite Line {cone_lines[3]} = nx_3 ;
cone_lines[4] = newl;
...
Line(inlet_lines[1]) = {pList_in1[1], pList_in1[3]}; Transfinite Line {inlet_lines[1]} = nx_1;
inlet_lines[2] = newl;
//Line(inlet_lines[2]) = {pList_in1[3], pList_in1[4]}; Transfinite Line {inlet_lines[2]} = nx_2 Using Progression 1.0025;
Bezier(inlet_lines[2]) = {pList_in1[3], dummy_p1, dummy_p2, pList_in1[4]}; Transfinite Line {inlet_lines[2]} = nx_2 Using Progression 1.00;
inlet_lines[3] = newl;
Line(inlet_lines[3]) = {pList_in1[4], pList_in1[5]}; Transfinite Line {inlet_lines[3]} = nx_3 ;
inlet_lines[4] = newl;
...
//////span lines
span_lines[0] = newl;
Line(span_lines[0]) = {pList1[0], pList_in1[0]}; Transfinite Line {span_lines[0]} = ny Using Progression 1.01;
span_lines[1] = newl;
...
span_lines[2] = newl;
Line(span_lines[2]) = {pList1[3], pList_in1[3]}; Transfinite Line {span_lines[2]} = ny Using Progression 1.01;
span_lines[3] = newl;
Line(span_lines[3]) = {pList1[4], pList_in1[4]}; Transfinite Line {span_lines[3]} = ny Using Progression 1.01;
span_lines[4] = newl;
Line(span_lines[4]) = {pList1[5], pList_in1[5]}; Transfinite Line {span_lines[4]} = ny Using Progression 1.01;
span_lines[5] = newl;
Line(span_lines[5]) = {pList1[6], pList_in1[6]}; Transfinite Line {span_lines[5]} = ny Using Progression 1.01;
span_lines[6] = newl;
Line(span_lines[6]) = {pList1[7], pList_in1[7]}; Transfinite Line {span_lines[6]} = ny Using Progression 1.01;
span_lines[7] = newl;
Line(span_lines[7]) = {pList1[8], pList_in1[8]}; Transfinite Line {span_lines[7]} = ny Using Progression 1.01;
...
//+
//Physical Volume(" fluid", 7) -= {7, 6, 5};
////+
//Physical Surface(" inlet", 1) -= {183, 161, 139, 134, 156, 178, 126, 27, 130, 152, 174, 28, 148, 29, 170};
////+
//
//
...
span_lines[2] = newl;
Line(span_lines[2]) = {pList1[2], pList_in1[2]}; Transfinite Line {span_lines[2]} = ny Using Progression 1.04;
span_lines[3] = newl;
Line(span_lines[3]) = {pList1[3], pList_in1[3]}; Transfinite Line {span_lines[3]} = ny Using Progression 1.04;
span_lines[4] = newl;
Line(span_lines[4]) = {pList1[4], pList_in1[4]}; Transfinite Line {span_lines[4]} = ny Using Progression 1.04;
span_lines[5] = newl;
Line(span_lines[5]) = {pList1[5], pList_in1[5]}; Transfinite Line {span_lines[5]} = ny Using Progression 1.04;
span_lines[6] = newl;
Line(span_lines[6]) = {pList1[6], pList_in1[6]}; Transfinite Line {span_lines[6]} = ny Using Progression 1.04;

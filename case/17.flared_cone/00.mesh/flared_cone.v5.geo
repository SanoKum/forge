...
pList_in1[1] = newp;
Point(pList_in1[1]) = {x1-0.10 , y1*10 , 0.0 , lc};

pList_in1[2] = newp;
Point(pList_in1[2]) = {x2-1.8 , y2*30 , 0.0 , lc};

pList_in1[3] = newp;
Point(pList_in1[3]) = {x3-2.5 , y3*10 , 0.0 , lc};

pList_in1[4] = newp;
Point(pList_in1[4]) = {x4-3.7, y4*3.6 , 0.0 , lc};

pList_in1[5] = newp;
Point(pList_in1[5]) = {x5-6, y5*2.3 , 0.0 , lc};
...
// *** inlet line 1 ***
pList_inner[0] = newp;
Point(pList_inner[0]) = {-0.82, 0.30, 0.0, 1.0};
...
INLET_LINES[1] = newl;
Bezier(newl) = {pList_in1[1], pList_inner[1], pList_inner[2], pList_in1[2]}; Transfinite Line {INLET_LINES[1]} = nx_1 Using Progression 1.002;

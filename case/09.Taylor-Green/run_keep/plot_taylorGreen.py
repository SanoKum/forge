...
ax1.plot(time[0:len(ros4)], ros4, linewidth=1.0, color='g', label="4th")
...
ax2.plot(time[0:len(rok4)], rok4, linewidth=1.0, color='g', label="4th")
...
#4th redo
with open("log_4th_fixDT", "r") as f:
	lines = f.read().splitlines()

...
- **related_docs**:
  - `methods/turbulence/theory.md` (§6.5)
  - `methods/turbulence/implementation.md` (§3.7)
- **related_plans**:
...
理論は [`methods/turbulence/theory.md`](../../methods/turbulence/theory.md) §6.5、実装対応は
...
- docs: `methods/turbulence/theory.md` (§6.5), `methods/turbulence/implementation.md` (§3.7)。新規ファイルなし。
- 既定 `wallTreatmentSST=0` のため既存ケース・回帰は不変 (opt-in)。

## 8. 完了条件

- [x] `methods/turbulence/theory.md` 更新済み (§6.5)
- [x] `methods/turbulence/implementation.md` 更新済み (§3.7)
- [x] 実装・検証完了 (本 plan §6)

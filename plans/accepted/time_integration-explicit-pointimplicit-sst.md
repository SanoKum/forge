...
- 消散ヤコビアンの定義と block 陰解法側の point-implicit は
  [`methods/time_integration/theory.md`](../../methods/time_integration/theory.md) §"スカラー (k/ω) の陰解法"、
  [`methods/turbulence/implementation.md`](../../methods/turbulence/implementation.md) §6 を参照。

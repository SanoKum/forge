...
- **status**: `done`
- **related_docs**:
  - `procedures/solver-settings.md`（`detectNaN` 設定リファレンス）
- **created**: `2026-06-11`
- **owner**: `CFD Dev`
...
理論変更を伴わない純粋な診断機能のため `methods/<area>` の theory/implementation は新設しない。
...
- `procedures/solver-settings.md` に `detectNaN` 節を追加済み。
...
- ドキュメント: `procedures/solver-settings.md` に節追加。

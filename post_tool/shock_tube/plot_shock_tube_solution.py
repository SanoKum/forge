...
if __name__ == '__main__':
    ...
    # *** Plot ***
    # ------------
    fig, axes = plt.subplots(ncols=2, nrows=3, figsize=(12,6.5), sharex=True )
    ...
    axes[2,0].plot(x, u, linewidth=1, label="Exact", color="black")
    #axes[2,0].plot(x_cfd, u_cfd, label="FR Solver 1", linestyle='None', marker="o", markersize=2, color="red")
    axes[2,0].plot(x_cfd, u_cfd, label="FR Solver 1", linewidth=2, color="red")

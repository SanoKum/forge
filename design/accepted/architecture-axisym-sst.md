...
- **status**: `done`
- **related_docs**:
  - [`docs/turbulence/theory.md`](../../docs/turbulence/theory.md) (§7)
  - [`docs/turbulence/implementation.md`](../../docs/turbulence/implementation.md) (§5)
...
- 理論: [theory.md §7](../../docs/turbulence/theory.md) (フープひずみ・圧縮性・診断量再利用)。
- 実装: [implementation.md §5](../../docs/turbulence/implementation.md)。
- 軸対称 B 流儀の前提: [axisymmetric/theory.md](../../docs/axisymmetric/theory.md)。
- 既存診断量の供給元:
...
- [x] 関連 `docs/turbulence/theory.md` §7 更新済み
- [x] 関連 `docs/turbulence/implementation.md` §5 更新済み

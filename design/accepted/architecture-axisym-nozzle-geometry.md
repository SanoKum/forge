...
- 軸対称 solver 側の理論・実装は [`docs/axisymmetric/`](../../docs/axisymmetric/) を参照。
...
1. `docs/axisymmetric/theory.md`, `docs/axisymmetric/implementation.md` に検証ノズル形状の位置づけを追記する。
...
- [x] 関連 `docs/axisymmetric/theory.md` 更新済み
- [x] 関連 `docs/axisymmetric/implementation.md` 更新済み
